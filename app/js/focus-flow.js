...
(() => {
  const copy = {
    de: {
      ...
      localStored:'Daten lokal gespeichert', footer:'Daten werden lokal gespeichert · Läuft offline · v1.1',
    ...
    en: {
      ...
      localStored:'Data stored locally', footer:'Data stored locally · Works offline · v1.1',
