# BudgetApp – archivierte Versionshistorie

Diese Datei bewahrt die Versionshistorie der Vorgänger-App BudgetApp auf.
BudgetAtlas entstand später als eigenständiges Redesign. Übernommene Funktionen und Datenformate bleiben dort dokumentiert, gehören jedoch nicht zur BudgetAtlas-Versionsreihe.
